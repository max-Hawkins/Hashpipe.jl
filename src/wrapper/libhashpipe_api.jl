...
function hgetu8(hstring, keyword, val)
    ccall((:hgetu8, libhashpipe), Cint, (Cstring, Cstring, Ptr{uint8}), hstring, keyword, val)
end
...
function hputi8(hstring, keyword, ival)
    ccall((:hputi8, libhashpipe), Cint, (Cstring, Cstring, int8), hstring, keyword, ival)
end
...
function hputu8(hstring, keyword, ival)
    ccall((:hputu8, libhashpipe), Cint, (Cstring, Cstring, uint8), hstring, keyword, ival)
end
...
# Julia wrapper for header: hashpipe_pktsock.h
# Automatically generated using Clang.jl


function hashpipe_pktsock_open(p_ps, ifname, ring_type)
    ccall((:hashpipe_pktsock_open, libhashpipe), Cint, (Ptr{hashpipe_pktsock}, Cstring, Cint), p_ps, ifname, ring_type)
end

function hashpipe_pktsock_recv_frame_nonblock(p_ps)
    ccall((:hashpipe_pktsock_recv_frame_nonblock, libhashpipe), Ptr{Cuchar}, (Ptr{hashpipe_pktsock},), p_ps)
end

function hashpipe_pktsock_recv_frame(p_ps, timeout_ms)
    ccall((:hashpipe_pktsock_recv_frame, libhashpipe), Ptr{Cuchar}, (Ptr{hashpipe_pktsock}, Cint), p_ps, timeout_ms)
end

function hashpipe_pktsock_recv_udp_frame_nonblock(p_ps, dst_port)
    ccall((:hashpipe_pktsock_recv_udp_frame_nonblock, libhashpipe), Ptr{Cuchar}, (Ptr{hashpipe_pktsock}, Cint), p_ps, dst_port)
end

function hashpipe_pktsock_recv_udp_frame(p_ps, dst_port, timeout_ms)
    ccall((:hashpipe_pktsock_recv_udp_frame, libhashpipe), Ptr{Cuchar}, (Ptr{hashpipe_pktsock}, Cint, Cint), p_ps, dst_port, timeout_ms)
end

function hashpipe_pktsock_release_frame(frame)
    ccall((:hashpipe_pktsock_release_frame, libhashpipe), Cvoid, (Ptr{Cuchar},), frame)
end

function hashpipe_pktsock_stats(p_ps, p_pkts, p_drops)
    ccall((:hashpipe_pktsock_stats, libhashpipe), Cvoid, (Ptr{hashpipe_pktsock}, Ptr{UInt32}, Ptr{UInt32}), p_ps, p_pkts, p_drops)
end

function hashpipe_pktsock_close(p_ps)
    ccall((:hashpipe_pktsock_close, libhashpipe), Cint, (Ptr{hashpipe_pktsock},), p_ps)
end
...
# Julia wrapper for header: hashpipe_udp.h
# Automatically generated using Clang.jl


function hashpipe_udp_init(p)
    ccall((:hashpipe_udp_init, libhashpipe), Cint, (Ptr{hashpipe_udp_params},), p)
end

function hashpipe_udp_close(p)
    ccall((:hashpipe_udp_close, libhashpipe), Cint, (Ptr{hashpipe_udp_params},), p)
end
